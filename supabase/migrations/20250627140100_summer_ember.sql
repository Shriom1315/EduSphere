/*
  ...
  1. New Tables
    ...
    - `users` - All system users (super_admin, principal, teacher, student)
    - `classes` - Class/grade sections within schools
    - `subjects` - Academic subjects taught in classes
...
-- Insert initial super admin user (optional)
